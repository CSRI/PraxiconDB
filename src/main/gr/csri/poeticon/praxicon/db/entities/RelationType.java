...
@XmlType(name = "relation_type", namespace =
        "http://www.csri.gr/relation_type")
@Entity
@NamedQueries({
...
public class RelationType implements Serializable {
    ...
    public static enum RelationNameForward {
        ...
        ASPECT_ABSTRACT_ENTITY, ASPECT_ABSTRACT_FEATURE, COMPARED_WITH,
        ENABLES, EVENT_STEP, HAS_ANTHROPOGENIC_EFFECT, HAS_COLOUR,
        HAS_CONDITION, HAS_CONTENT, HAS_DENSITY, HAS_DEPTH, HAS_DIRECTION,
        HAS_FORCE, HAS_FREQUENCY, HAS_HEIGHT, HAS_HUE, HAS_MOTOR_PROGRAM,
        HAS_INSTANCE, HAS_INTENSITY, HAS_LENGTH, HAS_LOCATION, HAS_LUMINANCE,
        HAS_MATERIAL, HAS_MATERIAL_RESISTANCE, HAS_MEASUREMENT_UNIT,
        HAS_MEASUREMENT_VALUE, HAS_NATURAL_EFFECT, HAS_PART,
        HAS_PARTIAL_INSTANCE, HAS_REGION, HAS_SHAPE, HAS_SIZE, HAS_SPEED_RATE,
        HAS_TEMPERATURE, HAS_TEXTURE, HAS_TIME, HAS_VALUE, HAS_VISUAL_PATTERN,
        HAS_VOLUME, HAS_WEIGHT, HAS_WIDTH, LESS, MORE, TYPE_TOKEN;
    ...
    public static enum RelationNameBackward {
        ...
        ABSTRACT_ENTITY_ASPECT, ABSTRACT_FEATURE_ASPECT, ENABLED_BY,
        STEP_EVENT, ANTHROPOGENIC_EFFECT_OF, COLOUR_OF, CONDITION_OF,
        CONTENT_OF, DENSITY_OF, DEPTH_OF, DIRECTION_OF, FORCE_OF, FREQUENCY_OF,
        HEIGHT_OF, HUE_OF, MOTOR_PROGRAM_OF, INSTANCE_OF, INTENSITY_OF,
        LENGTH_OF, LOCATION_OF, LUMINANCE_OF, MATERIAL_OF,
        MATERIAL_RESISTANCE_OF, MEASUREMENT_UNIT_OF, MEASUREMENT_VALUE_OF,
        NATURAL_EFFECT_OF, PART_OF, PARTIAL_INSTANCE_OF, REGION_OF, SHAPE_OF,
        SIZE_OF, SPEED_RATE_OF, TEMPERATURE_OF, TEXTURE_OF, TIME_OF, VALUE_OF,
        VISUAL_PATTERN_OF, VOLUME_OF, WEIGHT_OF, WIDTH_OF, NO, TOKEN_TYPE;
